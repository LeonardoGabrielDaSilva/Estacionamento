...
public class ExportarImportar {
	...
	public boolean exportarFuncionario(List<Funcionario> lista) throws IOException {
		GsonBuilder builder = new GsonBuilder();
		Gson gson = builder.create();
		FileWriter writer = new FileWriter("Jsons/Funcionarios.json");
		writer.write(gson.toJson(lista));
		writer.close();
		return true;
	}

	public List<Funcionario> importarFuncionario(List<Funcionario> lista) throws IOException {
		try {

			BufferedReader bufferedReader = new BufferedReader(new FileReader("Jsons/Funcionarios.json"));
